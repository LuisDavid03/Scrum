...
class mainformSB:
    ...
    mainframe = tk.Frame(rootSB,bg=bgcolor, width=w, height=h)

    frame_titulo = tk.Frame(mainframe,bg= oscuro_color, padx=8, pady=8)
    label_titulo = tk.Label(frame_titulo, text='SCRUM BOARD', padx=60, pady=1, bg= claro_color, fg=tex_oscuro_color, font=('IBM Plex Mono',35))
    ...
    button_to_do = tk.Button(frame_to_do, text='TO DO', pady=20, font=('IBM Plex Mono',23), fg=tex_claro_color, bg=claro_color)
    frame_in_progress = tk.Frame(mainframe, bg= oscuro_color, padx=4, pady=4)
    button_in_progress = tk.Button(frame_in_progress, text='IN PROGRESS', pady= 20,padx=34, font=('IBM Plex Mono', 23), fg=tex_claro_color, bg=claro_color)
    frame_done = tk.Frame(mainframe, bg= oscuro_color, padx=4, pady=4)
    button_done = tk.Button(frame_done, text='DONE', pady= 20,padx=34, font=('IBM Plex Mono', 23), fg=tex_claro_color, bg=claro_color)
    ...
    frame_to_do.place(x=180, y=350)  
    frame_in_progress.place(x=480, y=350) 
    frame_done.place(x=920, y=350)
